    ...
    <div className="space-y-20">
      ...
      <section className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* Feature 3 */}
          <div className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-100 hover:border-amber-200 hover:-translate-y-2">
      ...
      {/* Statistics Section */}
      <section className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-900 rounded-3xl px-8 py-16 shadow-2xl">
