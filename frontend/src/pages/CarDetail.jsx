      ...
      <div className="md:col-span-2">
        ...
        <div className="mb-6">
          ...
          <p className="text-lg mb-4" style={{ color: '#64748B' }}>
            Year: {car.carYear} | Type: {car.carType}
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-md mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p style={{ color: '#64748B' }} className="text-sm">Transmission</p>
              <p className="font-semibold">{car.transmission}</p>
            </div>
            <div>
              <p style={{ color: '#64748B' }} className="text-sm">Fuel Type</p>
              <p className="font-semibold">{car.fuelType}</p>
            </div>
            <div>
              <p style={{ color: '#64748B' }} className="text-sm">Seats</p>
        ...
        <div className="bg-white rounded-xl p-6 shadow-md">
          <h2 className="text-xl font-bold mb-4" style={{ color: '#0F172A' }}>Description</h2>
          <p style={{ color: '#475569' }}>{car.description || 'No description available'}</p>
        </div>
      </div>
